...
public class ServerFacade {
    ...
    private static final String SERVER_URL = "https://e267a03n0a.execute-api.us-east-1.amazonaws.com/dev";
    ...
    public GetUserResponse getuser(GetUserRequest request, String url_path) throws IOException, TweeterRemoteException {
        return clientCommunicator.doPost(url_path, request, null, GetUserResponse.class);
    }
}
